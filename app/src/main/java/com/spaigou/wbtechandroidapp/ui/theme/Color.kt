...
val BrandColorBackground = Color(0xFFF5ECFF)//use for background
...
val Gradient01 = Brush.linearGradient(listOf(Color(0xFFD2D5F9), Color(0xFF2C37E1)))
val Gradient02 = Brush.linearGradient(listOf(Color(0xFFEC9EFF), Color(0xFF5F2EEA)))